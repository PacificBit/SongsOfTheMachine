...
import com.pacificbytestudios.songsofthemachine.interactions.DebugBuildPath;
...
import com.pacificbytestudios.songsofthemachine.systems.OrthogonalAStar;
...
public final class SongsOfTheMachine extends JavaPlugin {
  ...
  private ComponentType<ChunkStore, NeedsPathComponent> needsPathComponent;
  ...
  protected void setup() {
    ...
    this.needsPathComponent = this.getChunkStoreRegistry()
        .registerComponent(NeedsPathComponent.class, "NeedsPathComponent", NeedsPathComponent.CODEC);
    System.out.println("[SongsOfTheMachine] Registered NeedsPathComponent");
    ...
    this.getCodecRegistry(Interaction.CODEC)
        ...
        .register("DebugBuildPathInteraction",
            DebugBuildPath.class,
            DebugBuildPath.CODEC);
    System.out.println("[SongsOfTheMachine] Registered Interactions");
    ...
    this.getChunkStoreRegistry().registerSystem(new OrthogonalAStar());
  ...
  public ComponentType<ChunkStore, NeedsPathComponent> getNeedsPathComponentType() {
    return this.needsPathComponent;
  }
